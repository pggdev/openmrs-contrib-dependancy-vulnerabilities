...
import { ThirdDropdown } from "../thirdlayer/thirddropdown"
...
export const Secondlayerdropdown = () => {
    ...
    return <div className="">
        ...
        {Rows.map((row, index) => <div key={index} className="flex flex-col">
            ...
            {openRowIndex === index && <ThirdDropdown />}
